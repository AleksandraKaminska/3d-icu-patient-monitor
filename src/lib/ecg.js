...
function gaussian(t, center, amplitude, width) {
  const d = t - center
 ...
 */
export function ecgSample(phase, respPhase = 0) {
  let v = 0
 ...
 */
export function plethSample(phase, spo2 = 98) {
